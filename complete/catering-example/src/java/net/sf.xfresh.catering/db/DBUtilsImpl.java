...
public class DBUtilsImpl implements DBUtils{
    ...
    public DBUtilsImpl(SimpleJdbcTemplate jdbcTemplate) {
    ...
    public Collection<Integer> getUnIndexed() throws DataAccessException {
        return jdbcTemplate.query("SELECT id FROM positions WHERE isIndexed = false", INTEGER_LOLWUT_MAPPER);
    }

    public void setIndexed(Integer id) throws DataAccessException {
        jdbcTemplate.update("UPDATE positions SET isIndexed = true WHERE id = ?", new Object[]{id});
    }
