 ...
 * 
 * @author Kononov Vladislav, Grechko Vladislav
 */
...
public class IndexBuilder {
	...
	/*
	 * Gets values for url with database, username and password for it and path
	 * where to put index
	 */
	public IndexBuilder(String url, String path, String username,
